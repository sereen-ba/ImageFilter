# In this file it will app a filter on the choosen image with a controll panle to set the filter
#!/usr/bin/env python
...
# defineing the filter function with 3 features
...
def main():
    ...
    def nothing(*argv):
        pass
# throw the controll panel you can set the 3 featuers and updete it on your image
    def update():
